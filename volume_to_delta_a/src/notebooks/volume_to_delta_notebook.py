...
# MAGIC %md
# MAGIC # Volume to Delta - Notebook (Projeto A)
...
dbutils.widgets.text("volume_name", "raw_data_a", "Volume de Origem")
dbutils.widgets.text("table_name", "processed_data_a", "Tabela de Destino")
