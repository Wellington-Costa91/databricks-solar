"""
Volume to Delta - Script principal (Projeto C)
...
def process_volume_to_delta(
    ...
    print("=" * 60)
    print("🚀 VOLUME TO DELTA C - INICIANDO PROCESSAMENTO")
    print("=" * 60)
...
def main():
    ...
    volume_name = os.environ.get("VOLUME_NAME", "raw_data_c")
    table_name = os.environ.get("TABLE_NAME", "processed_data_c")
