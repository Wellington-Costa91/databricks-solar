...
# MAGIC %md
# MAGIC # Volume to Delta - Notebook (Projeto C)
...
dbutils.widgets.text("volume_name", "raw_data_c", "Volume de Origem")
dbutils.widgets.text("table_name", "processed_data_c", "Tabela de Destino")
